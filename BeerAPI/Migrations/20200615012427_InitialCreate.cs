        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreweryName = table.Column<string>(maxLength: 50, nullable: false),
                    MasterBrewer = table.Column<string>(maxLength: 50, nullable: true),
                    Address = table.Column<string>(maxLength: 30, nullable: true),
                    StateAbbr = table.Column<string>(maxLength: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BeerId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BeerName = table.Column<string>(maxLength: 80, nullable: false),
                    BeerClass = table.Column<string>(maxLength: 10, nullable: true),
                    BeerDescription = table.Column<string>(maxLength: 500, nullable: true),
                    Abv = table.Column<decimal>(type: "decimal(3,2)", nullable: false),
